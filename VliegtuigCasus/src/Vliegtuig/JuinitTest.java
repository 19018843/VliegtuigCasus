...
public class JuinitTest {
    ...
    public void getPrijs() {
        ...
        Vliegtuig v4 = new Vliegtuig(5000, Landen.Nederland, 1, false);
        Vliegtuig v5 = new Vliegtuig(5000, Landen.Anders, 2, true);

        Vliegtuig v6 = new Vliegtuig(500, Landen.Nederland, 2, false);
        Vliegtuig v7 = new Vliegtuig(1000, Landen.Anders, 1, true);
        ...
        assertEquals(121, schiphol.getPrijsBijLanden(v6), 0.001);
        assertEquals(1300, schiphol.getPrijsBijLanden(v7), 0.001);
    }
}
